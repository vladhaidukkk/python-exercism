    ...
    def test_send_to_store(self):
        input_data = [
            ...
            (
                ...
                {
                    "Apple": ["Isle 1", False],
                    "Raspberry": ["Isle 6", False],
                    "Blueberries": ["Isle 6", False],
                    "Broccoli": ["Isle 3", False],
                    "Kiwi": ["Isle 6", False],
                    "Melon": ["Isle 6", False],
                },
            ),
        ...
        output_data = [
            ...
            {
                "Yoghurt": [2, "Isle 2", True],
                "Milk": [5, "Isle 2", True],
                "Kiwi": [3, "Isle 6", False],
                "Juice": [5, "Isle 5", False],
            },
            {
                "Raspberry": [2, "Isle 6", False],
                "Melon": [4, "Isle 6", False],
                "Kiwi": [1, "Isle 6", False],
                "Broccoli": [2, "Isle 3", False],
                "Blueberries": [5, "Isle 6", False],
                "Apple": [2, "Isle 1", False],
            },
        ]
    ...
    def test_update_store_inventory(self):
        input_data = [
            ...
            (
                ...
                {
                    "Apple": [2, "Isle 1", False],
                    "Raspberry": [5, "Isle 6", False],
                    "Blueberries": [10, "Isle 6", False],
                    "Broccoli": [4, "Isle 3", False],
                    "Kiwi": [1, "Isle 6", False],
                    "Melon": [8, "Isle 6", False],
                },
            ),
        ]
        ...
        output_data = [
            ...
            },
            {
                ...
                "Yoghurt": [2, "Isle 2", True],
                "Milk": [5, "Isle 2", True],
                "Kiwi": ["Out of Stock", "Isle 6", False],
            },
            {
                "Kiwi": ["Out of Stock", "Isle 6", False],
                "Melon": [4, "Isle 6", False],
                "Apple": ["Out of Stock", "Isle 1", False],
                "Raspberry": [3, "Isle 6", False],
                "Blueberries": [5, "Isle 6", False],
                "Broccoli": [3, "Isle 3", False],
            },
        ]
